...
export const theme = createTheme({
  ...
  primaryColor: 'yellow',
  colors: {
    yellow: ["#f7941d", "#de851a", "#c67617", "#ad6814", "#945911", "#f89f34", "#f9a94a", "#f9b461", "#fabf77", "#fbca8e"],
    blue:["#2670c5", "#2a7edd", "#2f8cf6", "#2162ac", "#1c5494", "#4498f7", "#59a3f8", "#6daff9", "#82bafa", "#97c6fb"],
    black:["#000000", "#0a0a0a", "#141414", "#1e1e1e", "#282828", "#1a1a1a", "#2e2e2e", "#424242", "#565656", "#6a6a6a"],
    white:["#ffffff", "#f9f9f9", "#f3f3f3", "#ededed", "#e7e7e7", "#f7f7f7", "#f1f1f1", "#ebebeb", "#e5e5e5", "#dfdfdf"],
