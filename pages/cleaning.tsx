...
import qualified from '@/public/images/badge.png';
import office from '@/public/images/building.png';
import cleaner from '@/public/images/cleaner.png';
import fence from '@/public/images/fence.png';
import flexible from '@/public/images/flexible.png';
import move from '@/public/images/fridge.png';
...
import renovation from '@/public/images/maintenance.png';
import nature from '@/public/images/nature-product.png';
...
export default function Cleaning() {
  ...
  const advantages = [
    {
      title: t('advantages.product.title'),
      text: t('advantages.product.text'),
      icon: nature,
    },
    {
    ...
    {
      title: t('advantages.cleaner.title'),
      text: t('advantages.cleaner.text'),
      icon: qualified,
    },
    {
      title: t('advantages.tools.title'),
      text: t('advantages.tools.text'),
      icon: windows,
    },
  ];
  ...
  const services = [
    {
      ...
      text: t('services.renovation.text'),
      icon: renovation,
    },
    {
      title: t('services.move.title'),
      text: t('services.move.text'),
      icon: move,
    },
    {
      title: t('services.office.title'),
      text: t('services.office.text'),
      icon: office,
    },
    {
    ...
    <>
      ...
      <Box>
        ...
        <Box py={theme.spacing?.xl}>
          <Container size="90%">
            <Title c={theme.colors?.blue?.[0]} order={2} ta="center">
              {t('advantages.title')}
            </Title>
...
export async function getStaticProps({ locale = 'en' }: GetStaticPropsContext) {
  return {
    props: {
      ...(await serverSideTranslations(locale, ['common', 'cleaning'])),
    },
  };
}
