...
import assembly from '@/public/images/assembly.png';
import mover from '@/public/images/deliver.png';
// import fence from "@/public/images/fence.png";
import team from '@/public/images/exclusive.png';
import flexible from '@/public/images/flexible2.png';
import equipment from '@/public/images/forklift.png';
...
import secure from '@/public/images/moving-truck.png';
import packaging from '@/public/images/package-delivered.png';
import local from '@/public/images/route.png';
import storage from '@/public/images/secure-storage.png';
...
export default function Moving() {
  ...
  const advantages = [
    ...
    },
    {
      ...
      text: t('advantages.team.text'),
      icon: team,
    },
    {
      title: t('advantages.equipment.title'),
      text: t('advantages.equipment.text'),
      icon: equipment,
    },
  ];
  ...
  const services = [
    {
      ...
      text: t('services.local.text'),
      icon: local,
    },
    {
      title: t('services.packing.title'),
      text: t('services.packing.text'),
      icon: packaging,
    },
    {
      title: t('services.furniture.title'),
      text: t('services.furniture.text'),
      icon: assembly,
    },
    {
      title: t('services.storage.title'),
      text: t('services.storage.text'),
      icon: storage,
    },
    // {
    ...
    <>
      ...
      <Box>
        ...
        <Box py={theme.spacing?.xl}>
          <Container size="90%">
            <Title c={theme.colors?.indigo?.[0]} order={2} ta="center">
              {t('advantages.title')}
            </Title>
...
export async function getStaticProps({ locale = 'en' }: GetStaticPropsContext) {
  return {
    props: {
      ...(await serverSideTranslations(locale, ['common', 'moving'])),
    },
  };
}
